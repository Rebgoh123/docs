...
export function additional(state = {}, action) {
    switch (action.type) {
        case formConstants.GET_TYPE_REQUEST:
        return {
            loading: true,
        };

        case formConstants.GET_TYPE_SUCCESS:
            return {
                forms: action.forms
            };

        case formConstants.GET_TYPE_FAILURE:
            return {
                error: action.error
            };

        case formConstants.GET_CLIENT_DATA_REQUEST:
            return {
                loading: true,
            };

        case formConstants.GET_CLIENT_DATA_SUCCESS:
            return {
                forms: action.form
            };

        case formConstants.GET_CLIENT_DATA_FAILURE:
            return {
                error: action.error
            };
        default:
